...
#include "UnrealTest2Projectile.h"
...
//////////////////////////////////////////////////////////////////////////
// AUnrealTest2Character

AUnrealTest2Character::AUnrealTest2Character()
{
...
void AUnrealTest2Character::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("MoveRight", this, &AUnrealTest2Character::MoveRight);
...
{ 
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			...
			World->SpawnActor<AUnrealTest2Projectile>(ProjectileClass, SpawnLocation, SpawnRotation);
		}
	}
...
void AUnrealTest2Character::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AUnrealTest2Character::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AUnrealTest2Character::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AUnrealTest2Character::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AUnrealTest2Character::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AUnrealTest2Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

bool AUnrealTest2Character::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	bool bResult = false;
	if(FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch )
	{
		bResult = true;
		InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AUnrealTest2Character::BeginTouch);
		InputComponent->BindTouch(EInputEvent::IE_Released, this, &AUnrealTest2Character::EndTouch);
		InputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AUnrealTest2Character::TouchUpdate);
	}
	return bResult;
}
